...
const Signup = () => {
  ...
  return (
    ...
    <div className='w-full col-center p-2vw max-w-[90vw] m-auto'>
      ...
      <h1 className='text-[2vw] capitalize text-center leading-[3vw] text-black mt-vw font-bold'>Sign up to Build your own <br /> <span className="text-[#092370]">software team</span></h1>
      <section className="mt-vw w-full  col-center p-vw">
        <div className="flex mt-vw row-center p-[0.7vw] w-full max-w-[35vw] hover:bg-gray-100 bg-white rounded-full border-[2px] border-black focus:outline-none">
        <Icon icon="logos:apple" />
        <button className='text-black ml-[0.4vw] text-vw font-bold '>Continue with Apple</button>
        </div>
        <button className="w-full relative max-w-[35vw] row-center rounded-full p-[0.7vw] text-white text-center mt-vw font-bold text-vw bg-[#092370] hover:bg-[#092370]">
      ...
      <section className="mt-vw w-full col-center max-w-[35vw] p-vw">
        <div className="flex items-center justify-between w-full">
          <input type="text" placeholder="First name" className="w-full max-w-[16vw] bg-white p-[0.7vw] rounded-2xl border-[2px] border-[#E4EBE4] focus:outline-none" />
          <input type="text" placeholder="Last name" className="w-full max-w-[16vw] bg-white p-[0.7vw] rounded-2xl border-[2px] border-[#E4EBE4] focus:outline-none" />
        </div>
        <input type="email" placeholder="email" className="w-full max-w-[35vw] mt-vw bg-white p-[0.7vw] rounded-2xl border-[2px] border-[#E4EBE4] focus:outline-none" />
        <div className="flex items-center w-full max-w-[35vw] bg-white rounded-2xl mt-vw border-[2px] border-[#E4EBE4] focus:outline-none">
          ...
          <select className='w-full max-w-[35vw] mt-vw bg-white p-[0.7vw] rounded-2xl border-[2px] border-[#E4EBE4] focus:outline-none'>
        ...
        <button className="w-full max-w-[35vw] rounded-full text-white text-center p-[0.8vw] mt-vw font-bold text-vw bg-[#092370] hover:bg-[#092370ee]">Create my account</button>
      </section>
